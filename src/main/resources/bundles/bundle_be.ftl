...
badge-bug-finder-description = Выдаецца гульцам, якія рэгулярна знаходзяць сапраўдныя багі і афармляюць рэпарты так, каб іх можна было ўзнавіць і выправіць.
